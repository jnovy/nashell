...
static void test_superseded_hard_exclusion(void) {
  ...
  memory_set_recall_config(m, 0.01, 0.5f, 0.5f, 0.3f, 0.3f, 1.3f, 90.0f);
  ...
  memory_set_recall_config(m, 0.01, 0.5f, 0.5f, 0.3f, 0.0f, 1.3f, 90.0f);
...
static void test_superseded_chain(void) {
  ...
  memory_set_recall_config(m, 0.01, 0.5f, 0.5f, 0.0f, 0.3f, 1.3f, 90.0f);
  ...
  memory_set_recall_config(m, 0.01, 0.5f, 0.5f, 0.0f, 0.0f, 1.3f, 90.0f);
  results = memory_query(m, "version", 10);
  count_version = 0;
  int found_v3 = 0;
  for (int i = 0; i < results.count; i++) {
...
static void test_superseded_negative_demotion(void) {
  ...
  memory_set_recall_config(m, 0.01, 0.5f, 0.5f, 0.0f, -0.5f, 1.3f, 90.0f);
